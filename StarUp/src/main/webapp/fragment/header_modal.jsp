...
<body>
	<div class="container-fluid" style="position: relative; z-index: 10;">
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			<a class="navbar-brand" href="index.jsp">Star Up</a>
			...
			<div class="collapse navbar-collapse" id="navbarColor03">
				...
				<c:if test="${empty LoginOK}">
					<span class="badge badge-pill badge-warning"><a href="#" style="text-decoration: none;"
						onclick="document.getElementById('id01').style.display='block'">登入</a>
					</span> &nbsp;&nbsp;&nbsp; 
				</c:if>
				<c:if test="${!empty LoginOK}">
					<span class="badge badge-pill badge-warning"><a href="_02_login/logout.jsp" style="text-decoration: none;">登出</a>
					</span> &nbsp;&nbsp;&nbsp; 
...
<!-- 				&nbsp;&nbsp;&nbsp; -->
				<c:if test="${empty LoginOK}">
					<span class="badge badge-pill badge-info"><a href="Register.jsp" style="text-decoration: none;">註冊</a></span>
					&nbsp;&nbsp;&nbsp;
				</c:if>				
<!-- The Modal -->
...
class="close" title="Close Modal">&times;</span>
  ...
  <!-- Modal Content -->
  <form class="modal-content animate" action="login.do" method="POST" style="width:300px;height:300px;margin:100px auto; padding:30px; text-align:center;">
    <div class="container">
      <label for="account" style="margin:15px;"><b>帳號</b></label>
      <input type="text" placeholder="Enter Username" name="account" value="${requestScope.user}" required>
      &nbsp;<small><Font color='red' size="-3">${ErrorMsgKey.AccountEmptyError}</Font></small>
		<br>
      <label for="password" style="margin:15px;"><b>密碼</b></label>
      <input type="password" placeholder="Enter Password" name="password" value="${requestScope.password}" required>
		&nbsp;
		<br>
		<small><Font color='red'  size="-3">帳號或密碼錯誤，請重新輸入</Font></small>
		<br>
		<br>
		
      <button type="submit" class="btn btn-outline-primary" style="margin:10px;">Login</button>
      <button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn btn btn-outline-secondary">Cancel</button>
      
      	<br>
      <label>
        <input type="checkbox" checked="checked" name="remember" style="margin:0px 10px;"> Remember me
      </label>
    </div>
  </form>
</div>
